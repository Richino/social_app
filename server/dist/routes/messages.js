...
router.post("/read", auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const messages = yield client
            ...
            .toArray();
        const sender = yield client.collection("users").findOne({ _id: new ObjectId(req.user.id) });
        const recipient = yield client.collection("users").findOne({ _id: new ObjectId(user) });
